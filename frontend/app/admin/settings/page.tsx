...
export default function AdminSettings() {
  ...
  const handlePlatformSelect = async (platform: string) => {
    ...
    try {
      ...
      if (data.app_id) currentData.app_id = data.app_id;
      if (data.app_secret) currentData.app_secret = data.app_secret;
      if (data.access_token) currentData.access_token = data.access_token;
      if (data.verify_token) currentData.verify_token = data.verify_token;
      if (data.page_id) currentData.page_id = data.page_id;
      if (data.phone_number_id) currentData.phone_number_id = data.phone_number_id;
      if (data.business_account_id) currentData.business_account_id = data.business_account_id;
